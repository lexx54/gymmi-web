...
const WEEKLY_BARS: ChartBar[] = [
  { day: 'MON', heightPct: 40, hoverHeightPct: 60 },
  { day: 'TUE', heightPct: 65, hoverHeightPct: 45 },
  { day: 'WED', heightPct: 30, hoverHeightPct: 80 },
  { day: 'THU', heightPct: 90, hoverHeightPct: 70 },
  { day: 'FRI', heightPct: 75, hoverHeightPct: 95, active: true },
  { day: 'SAT', heightPct: 50, hoverHeightPct: 30 },
  { day: 'SUN', heightPct: 20, hoverHeightPct: 40 },
];
