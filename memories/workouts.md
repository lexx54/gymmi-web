...
- Trainers assign only contracted eligible clients. Assign creates a per-assignment routine fork; edit that fork from Clients detail without changing the library template.
